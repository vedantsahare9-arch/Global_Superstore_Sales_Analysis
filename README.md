...
- The West region recorded the best sales performance.
- Some sub-categories performed better than others.
- Sales varied across different customer segments.
# key Features
...
- Demonstrates data cleaning and analysis skills.
...
# Note
- GitHub cannot preview large Excel files. Please download the dataset or view the sample .xlsx file for a quick preview.
...
- Image:<img width="1402" height="763" alt="Sales Dashboard" src="https://github.com/user-attachments/assets/b658d30f-83db-46c9-9551-23443e457f5c" />
